...
from optimisation.util.rank_by_front_and_hypervolume import rank_by_front_and_hypervolume


class RankAndHypervolumeSurvival(Survival):
    ...
    def _do(self, problem, pop, n_survive, cons_val=None, gen=None, max_gen=None, **kwargs):
        ...
        survivors = rank_by_front_and_hypervolume(pop, n_survive, cons_val)
